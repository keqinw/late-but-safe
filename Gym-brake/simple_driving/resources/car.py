...
class Car:
    def __init__(self, client):
        ...
        self.c_rolling = 0.05
        self.c_drag = 0.02
        # Throttle constant decreases "speed" of the car
        self.c_throttle = 10

    def get_ids(self):
        return self.car, self.client

    def pre_accelerate(self):
    ...
    def apply_action(self, action):
        ...
        self.joint_speed = self.joint_speed + 1/10 * acceleration  # 1/30 in here should be same as the simulator step
    ...
    def get_observation(self):
        ...
        vel = p.getBaseVelocity(self.car, self.client)[0][0]

        # Get the goal (goal condition Method) 
        # goal = self.goal
