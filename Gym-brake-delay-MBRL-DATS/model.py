...
class PENN(nn.Module):
    ...
    def __init__(self, num_nets, num_delay, state_dim, action_dim, learning_rate, device=None):
        """
    ...
    def create_network(self, n):
        layer_sizes = [self.state_dim + self.num_delay*self.action_dim + self.action_dim, HIDDEN1_UNITS, HIDDEN2_UNITS, HIDDEN3_UNITS]
